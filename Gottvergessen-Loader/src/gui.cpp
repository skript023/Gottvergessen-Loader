...
namespace gottvergessen
{
	...
	void gui::dx_on_tick()
	{
		...
		ImGui::Begin("Gottvergessen Sense Loader", &m_opened, ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoSavedSettings | ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoScrollbar);
